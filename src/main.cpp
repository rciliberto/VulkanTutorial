...
private:
    ...
    void createInstance() {
        ...
        // Add VK_KHR_get_physical_device_properties2 for portability subset support
        ...
        bool hasMissingExtension = false;
        for (const auto &requiredExt: requiredExtensions) {
            ...
            if (found) {
                std::cout << '\t' << requiredExt << " - supported\n";
            } else {
                std::cout << '\t' << requiredExt << " - NOT SUPPORTED\n";
                hasMissingExtension = true;
            }
        }
        std::cout << std::endl;

        if (hasMissingExtension) {
    ...
    void createSyncObjects() {
        ...
        // Per-frame semaphores and fences (image-available + in-flight fences)
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
    ...
    void drawFrame() {
        ...
        // Use semaphore associated with this swapchain image index
